                        ...
                        <template v-if="detailTab === 'info'">
                            ...
                            <div class="info-section">
                                ...
                                <div class="file-summary">
                                    ...
                                    <button class="file-details-toggle" @click="showFileDetails = !showFileDetails">
                                ...
                                <div v-if="showFileDetails" class="file-details">
                                    ...
                                    <div v-if="!selectedModel.zip_path" style="margin-top:10px">
                                        <button class="btn btn-sm btn-secondary" @click="renameModelFile" title="Rename the file on disk to match the model name">
